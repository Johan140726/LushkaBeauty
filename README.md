...
\- Consulta del detalle de los productos.
...
2\. Implementación del catálogo de productos.

3\. Implementación de usuarios y roles.

4\. Integración con API y base de datos.

5\. Implementación del carrito y pedidos.

6\. Gestión administrativa.

7\. Pruebas y aseguramiento de calidad.

8\. Generación de la aplicación Android mediante Capacitor.
...
ionic start lushka-beauty blank --type=angular --capacitor

cd lushka-beauty

ionic g page paginas/principal
